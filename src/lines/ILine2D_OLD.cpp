...
namespace GLPL {
    ...
    ILine2D_OLD::ILine2D_OLD() {

    }

    void ILine2D_OLD::createAndSetupBuffers(GLuint *VAOPt, GLuint *VBOPt, int dataSizeBytes, const void *dataAddress,
    ...
    void
    ILine2D_OLD::drawData(Shader shader, glm::mat4 axesLimitViewportTrans, GLuint *VAOPt, glm::vec3 colour, int nPts,
                          GLenum mode) {
    ...
    void ILine2D_OLD::setLineColour(glm::vec3 lineColor) {
        this->colour = lineColor;
    }

    void ILine2D_OLD::setMode(GLenum newMode) {
        this->mode = newMode;
    }

    void ILine2D_OLD::setLineWidth(unsigned int newLineWidth) {
        this->lineWidth = newLineWidth;
    }

    glm::vec3 ILine2D_OLD::getColour() {
        return this->colour;
    }

    GLenum ILine2D_OLD::getMode() {
        return this->mode;
    }
