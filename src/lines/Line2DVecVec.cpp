...
#include "Line2DVecVec.h"

namespace GLPL {
    Line2DVecVec::Line2DVecVec(std::vector<std::vector<float>>* dataVecPt, int indexX, int indexY, GLenum mode) {
        ...
        void Line2DVecVec::Draw(Shader shader, glm::mat4 axesLimitViewportTrans) {
        ...
        std::vector<float> Line2DVecVec::getMinMax(bool onlyPositiveX, bool onlyPositiveY) {
