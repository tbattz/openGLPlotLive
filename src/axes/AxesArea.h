...
namespace GLPL {
    ...
    private:
        ...
        std::pair<float, float> calcAxesZoomLinearY(float zoomDir);
        std::pair<float, float> calcAxesZoomLogX(float zoomDir);
        std::pair<float, float> calcAxesZoomLogY(float zoomDir);
        void zoomAxes(float zoomDir);
        std::pair<float, float> calcAxesZoomDragLinearX();
        std::pair<float, float> calcAxesZoomDragLinearY();
        std::pair<float, float> calcAxesZoomDragLogX();
        std::pair<float, float> calcAxesZoomDragLogY();
        void zoomAxesByDragging();
        std::pair<float, float> calcAxesDragLinearX();
        std::pair<float, float> calcAxesDragLinearY();
        std::pair<float, float> calcAxesDragLogX();
        std::pair<float, float> calcAxesDragLogY();
